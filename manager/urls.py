...
from .views import M_OrderView, M_OrderViewD, M_TextileOrder,  SupplierOrderView, SupplierOrderSend, \
    M_TextileOrdered, M_TextilePayed, M_TextileShipped, M_TextileStock, M_TextileStayOut, SupplierCornice, \
    M_CorniceOrder, M_CorniceOrdered, M_CornicePayed, M_CorniceShipped, M_CorniceStock, M_CorniceStayOut, \
